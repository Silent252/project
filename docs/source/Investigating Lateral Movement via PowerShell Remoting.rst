...
.. |image1| image:: media/image1.png
   :width: 6.26806in
   :height: 0.5125in
.. |A screen shot of a computer AI-generated content may be incorrect.| image:: media/image2.png
   :width: 6.26806in
   :height: 1.02153in
.. |A screenshot of a computer AI-generated content may be incorrect.| image:: media/image3.jpeg
   :width: 5.88819in
   :height: 2in
.. |image2| image:: media/image4.jpeg
   :width: 6.26806in
   :height: 1.92361in
.. |A white background with black text AI-generated content may be incorrect.| image:: media/image5.jpeg
   :width: 6.26806in
   :height: 0.92569in
.. |A diagram of a computer system AI-generated content may be incorrect.| image:: media/image6.png
   :width: 6.26806in
   :height: 4.75625in
.. |Detecting Offensive PowerShell Attack Tools – Active Directory & Azure AD/Entra ID Security| image:: media/image7.png
   :width: 4.26942in
   :height: 3.45149in
.. |A close up of a white background AI-generated content may be incorrect.| image:: media/image8.jpeg
   :width: 6.26806in
   :height: 1.02431in
.. |image3| image:: media/image9.png
   :width: 6.26806in
   :height: 4.21528in
.. |Windows registry subkey creation not generating logs (Windows event ID 4657) - Server Fault| image:: media/image10.png
   :width: 5.58878in
   :height: 6.04574in
.. |Well that escalated quickly: How a red team went from domain user to kernel memory \| Expel| image:: media/image11.png
   :width: 6.26806in
   :height: 4.13681in
